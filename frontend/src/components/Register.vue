...
<div class="min-w-screen min-h-screen bg-purple-100 flex items-center justify-center px-5 py-5">
    <img src="@/assets/bg.png" class="absolute z-0 ">
    <div class="bg-gray-100 z-10 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden" style="max-width:1000px">
        <div class="md:flex w-full">
            <div class="hidden md:block w-1/2 bg-gray-300 items-center">
                ...
                <img src="@/assets/brb.png" alt="" class="w-full h-full">
            </div>
            <div class="w-full md:w-1/2 py-10 px-5 md:px-10">
                ...
                <div>
                    <form @submit.prevent="register">
                        <div class="flex -mx-3">
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="text" v-model="first_name" name="first_name" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="John">
                                </div>
                            </div>
                            <div class="w-1/2 px-3 mb-5">
                                ...
                                <div class="flex">
                                    <div class="w-10 z-10 pl-1 text-center pointer-events-none flex items-center justify-center"><i class="mdi mdi-account-outline text-gray-400 text-lg"></i></div>
                                    <input type="text" v-model="last_name" name="last_name" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="Smith">
                                </div>
                            </div>
                        </div>
                        <div class="flex -mx-3">
                            <div class="w-full px-3 mb-5">
                                ...
                                <div class="flex">
                                    ...
                                    <input type="phone" v-model="phone" name="phone" class="w-full -ml-10 pl-10 pr-3 py-2 rounded-lg border-2 border-gray-200 outline-none focus:border-indigo-500" placeholder="johnsmith@example.com">
                                </div>
                            </div>
                        </div>
                        <div class="flex -mx-3">
                        ...
                        <div>
                            <p class="text-center text-gray-600">Already have an account? <router-link to="/login"  class="text-indigo-500 hover:text-indigo-700 font-semibold">Login</router-link></p>
                        </div>
                    </form>
                </div>
            </div>
